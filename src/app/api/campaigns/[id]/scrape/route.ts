...
import { scrapeTweets, scrapeMultipleKOLs, scrapeSingleTweet, type ScrapedTweet } from "@/lib/scraper/x-scraper";
...
export async function POST(
  ...
  try {
    ...
    const { mode = "all", kolIds, tweetUrls, autoImport = false } = body;
